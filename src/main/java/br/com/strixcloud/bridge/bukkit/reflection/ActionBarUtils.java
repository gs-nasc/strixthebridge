...
public class ActionBarUtils {
    ...
    /*
        Peguei uma Utils que eu tinha aqui no computador mesmo, pra dar uma adiantada
     */

    /*

    API made by: https://gamersboard.com.br/topic/45330-api-actionbar-em-menos-de-100-linhas-free/
    ...
    */
    ...
    public static void sendActionBarMessage(Player player, String message) {
        try
        {
            Object icb = CHATMESSAGE_CONSTRUCTOR.newInstance(new Object[] { message.replace("&", "§"), new Object[0] });
